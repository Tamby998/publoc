    ...
    <div class="row">
        <div class="col-12">
            <div class="col-md-12">
                <h1>Concepteur</h1>
                		<!-- MODAL ADD -->
                    <form action="<?php echo base_url() ?>index.php/Concepteur/update" method="post">
                          <div class="modal-body">
                            <input type="hidden" name="txt_hidden" value="<?php echo $concepteur->id; ?>">
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label">Titre</label>
                                            <div class="col-md-10">
                                              <input type="text" name="titre" id="titre" class="form-control" value="<?php echo $concepteur->titre; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label">Description</label>
                                            <div class="col-md-10">
                                              <textarea class="form-control" id="description" name="description" rows="3" required><?php echo $concepteur->description; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label">Contact</label>
                                            <div class="col-md-10">
                                              <input type="text" name="contact" id="contact" class="form-control" value="<?php echo $concepteur->contact; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label">Email</label>
                                            <div class="col-md-10">
                                              <input type="text" name="email" id="email" class="form-control" value="<?php echo $concepteur->email; ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                              <select class="form-control" name="status" id='status' onkeypress="refuserToucheEntree(event);" required>
                                                <option value="<?php echo $concepteur->status; ?>">Status</option>
