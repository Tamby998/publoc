    ...
    <div class="row">
        <div class="col-12">
            <div class="col-md-12">
                <h1>Concepteur</h1>
                		<!-- MODAL ADD -->
                    <form action="<?php echo base_url() ?>index.php/Concepteur/save" method="post">
            ...
            <table class="table table-striped table-bordered table-hover" id="mydata">
                ...
                <?php if((sizeof($concepteurs))>0){
                  foreach($concepteurs as $concepteur){
                    ?>
                <tbody>
                    <td><?php echo $concepteur->id; ?></td>
                    <td><?php echo $concepteur->titre; ?></td>
                    <td><?php echo $concepteur->description; ?></td>
                    <td><?php echo $concepteur->email; ?></td>
                    <td><?php echo $concepteur->contact; ?></td>
                    <td>
                      <?php
                        $status = $concepteur->status;
                        if ($status == 1) { ?>
                          <a href="Concepteur/update_status?$id=<?php echo $concepteur->id; ?>&$status=<?php echo $concepteur->status; ?>" type="button" class="btn btn-success" name="button">Active</a>
                     <?php
                   }else { ?>
                     <a href="Concepteur/update_status?$id=<?php echo $concepteur->id; ?>&$status=<?php echo $concepteur->status; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                     <?php
                   }
                       ?>
                    </td>
                    <td><a href="<?php echo base_url() ?>index.php/Concepteur/edit/<?php echo $concepteur->id; ?>" class="btn btn-success">Modifier</a>
                    <td><a href="<?php echo base_url() ?>index.php/Concepteur/delete/<?php echo $concepteur->id; ?>" class="btn btn-primary">supprimer</a>
                </tbody>
                <?php
              }
            }else{ ?>
              <h1>Aucun Concepteur recuperer</h1>
            <?php } ?>
            </table>
        </div>
    </div>
