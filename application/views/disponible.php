	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
      ...
      <div class="container">
          <div class="table-responsive">
            <br><center>
              <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/list/<?php echo $_SESSION['ID_REGISSEUR']; ?>" class="btn btn-info">Tous les Emplacements</a> || <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/disponible/<?php echo $_SESSION['ID_REGISSEUR']; ?>" class="btn btn-danger">Emplacements Disponibles</a>||<a class="btn btn-info" href="<?php echo base_url() ?>index.php/homeRegisseurControlleur/historique/<?php echo $_SESSION['ID_REGISSEUR'];?>" class="btn btn-info">Emplacement Assigner</a></center><br>
            <center><br>
            <form class="" action="<?php echo site_url('homeRegisseurControlleur/recherche'); ?>" method="post">
          ...
          <table class="table table-bordered   table-striped" style="margin-top:100px">
            <thead class="table__head">
              <tr class="winner__table">
                ...
                <th><i class="fa fa-caret-square-o-right" aria-hidden="true"></i> Actions</th>
                <th><i class="fa fa-gift" aria-hidden="true"></i> Assigner</th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr class="winner__table">
                ...
                <?php
                  ...
                  if ($status == 1) { ?>
                  <td><button type="button" class="btn btn-danger" name="button" disabled>Activer</button></td>
               <?php
             }else { ?>
               ...
               <?php
                 ...
                 ?>
                 <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/edit/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-primary">Modifier</a>
                 ...
                 <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/assigner/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-primary">Client</a></td>
              </tr>
            </tbody>
            <?php
            }
