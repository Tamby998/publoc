...
<body>
	    ...
	    <div class="container d-flex align-items-center">
	      ...
	      <nav class="main-nav d-none d-lg-block">
	        <ul>
	          ...
	          <li  class="active"><a href="<?php echo base_url() ?>index.php/Welcome/imprimerie">Annuaire</a></li>
    ...
    <br><br><center><a href="<?php echo base_url() ?>index.php/Welcome/concepteur" class="btn btn-primary">Concepteur</a>      ||    <a href="<?php echo base_url() ?>index.php/Welcome/imprimerie"class="btn btn-success">Imprimerie</a>     ||     <a href="<?php echo base_url() ?>index.php/Welcome/conseil"class="btn btn-primary">Conseil</a></center>
    ...
    <form class="" action="<?php echo site_url('Welcome/rechercheimp'); ?>" method="post">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4 wow bounceInUp" data-aos="zoom-in" data-aos-delay="100">
          <div class="box">
            ...
            <h4 class="title"><a href=""><?php echo $result->titre; ?></a></h4>
