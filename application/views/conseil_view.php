    ...
    <div class="row">
        <div class="col-12">
            <div class="col-md-12">
                <h1>Conseil</h1>
                		<!-- MODAL ADD -->
                    <form action="<?php echo base_url() ?>index.php/Conseil/save" method="post">
            ...
            <table class="table table-striped table-bordered table-hover" id="mydata">
                ...
                <?php if((sizeof($conseils))>0){
                foreach($conseils as $conseil){
                ?>
                <tbody>
                  <td><?php echo $conseil->id; ?></td>
                  <td><?php echo $conseil->titre; ?></td>
                  <td><?php echo $conseil->description; ?></td>
                  <td><?php echo $conseil->contact; ?></td>
                  <td><?php echo $conseil->email; ?></td>
                  <td>
                    <?php
                      $status = $conseil->status;
                      if ($status == 1) { ?>
                        <a href="Conseil/update_status?$id=<?php echo $conseil->id; ?>&$status=<?php echo $conseil->status; ?>" type="button" class="btn btn-success" name="button">Active</a>
                   <?php
                 }else { ?>
                   <a href="Conseil/update_status?$id=<?php echo $conseil->id; ?>&$status=<?php echo $conseil->status; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                   <?php
                 }
                     ?>
                  </td>
                  <td><a href="<?php echo base_url() ?>index.php/Conseil/edit/<?php echo $conseil->id; ?>" class="btn btn-success">Modifier</a>
                  <td><a href="<?php echo base_url() ?>index.php/Conseil/delete/<?php echo $conseil->id; ?>" class="btn btn-primary">supprimer</a>
              </tbody>
                <?php
                }
                }else{ ?>
