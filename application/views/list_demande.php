...
table td:last-child {
  border-bottom: 0;
    ...
    <br><br><table>
	  <caption><a href="<?php echo base_url() ?>index.php/homeClientControlleur/list_demande/<?php echo $_SESSION['ID_CLIENT2']; ?>"><center>Mes Demandes</center></a></caption>
        <!-- Table head -->
           <center><a href="<?php echo base_url() ?>index.php/homeClientControlleur/demande_client" class="btn btn-primary">Faire une Demande</a></center>
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <td><?php echo $data->lieu1; ?></td>
          <td><?php echo $data->SERVICE; ?></td>
        </tbody>
        <?php
        }
        }else{ ?>
          <td>Aucun Demmande pour le moment</td>
          <td>Aucun Demmande pour le moment</td>
          <td>Aucun Demmande pour le moment</td>
          <td>Aucun Demmande pour le moment</td>
          <td>Aucun Demmande pour le moment</td>
