            ...
            <div class="row">
                <div class="col-12">
                    <div class="col-md-12">
                        <h1>Modifier Blog</h1>
                        		<!-- MODAL ADD -->
                            <form action="<?php echo base_url() ?>index.php/homeAdminControlleur/update_sous" method="post">
                                  <div class="modal-body">
                                    <input type="hidden" name="txt_hidden" value="<?php echo $type->id; ?>">
                                                <div class="form-group row">
                                                    <label class="col-md-2 col-form-label">Titre</label>
                                                    <div class="col-md-10">
                                                      <input type="text" name="sous" id="sous" value="<?php echo $type->sous; ?>" class="form-control" placeholder="Type..." required>
                                                    </div>
                                                </div>
                                                      <!--  <div class="form-group row">
