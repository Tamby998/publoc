...
<li class="parent">
    ...
    <div class="row">
                 ...
                 <div class="jumbotron">
                     <div class="row text-center">
                         <div class="col-lg-4">
                             ...
                             <h2 class="name"><?php echo $carte->TYPE; ?></h2>
                             <h4 class="number">#<?php echo $carte->FACE;; ?></h4>
                         </div>
                         <div class="col-lg-8">
                             <table class="table">
                                 <tbody>
                                 <tr>
                                     ...
                                     <td><?php echo $carte->SERVICE; ?></td>
                                 </tr>

                                 <tr>
                                     <th><i class="fa fa-volume-control-phone" aria-hidden="true">  Habillage:</i></th>
                                     <td><?php echo $carte->HABILLAGE; ?></td>
                                 </tr>
                                 <tr>
                                     <th><i class="fa fa-map-marker" aria-hidden="true">Ville</i></th>
                                     <td><?php echo $carte->VILLE; ?></td>
                                 </tr>

                                 </tbody>

                                  <th><a class="btn btn-danger" href="<?php echo base_url() ?>index.php/homeRegisseurControlleur/delete/<?php echo $carte->id_carte; ?>">Fin de Contrat</a></th>
                                  <td><?php
                                    $status = $carte->status_carte;
                                    if ($status == 1) { ?>
                                      <a href="<?php echo base_url() ?>index.php/homeRegisseurControlleur/update_status?$id_carte=<?php echo $carte->id_carte; ?>&$status=<?php echo $carte->status_carte; ?>" type="button" class="btn btn-success" name="button">Active</a>
                                 <?php
                               }else { ?>
                                 <a href="<?php echo base_url() ?>index.php/homeRegisseurControlleur/update_status?$id_carte=<?php echo $carte->id_carte; ?>&$status=<?php echo $carte->status_carte; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                                 <?php
                               }
                                   ?>
                                 </td>
                                 <th><td><a href="<?php echo base_url() ?>index.php/homeRegisseurControlleur/cli_profile/<?php echo $carte->ID_CLIENT2; ?>" class="btn btn-info">Client</a></td></th>
                                   <tr>
                                     <?php $fin = $carte->fin;
                                      if ($fin == NULL) { ?>

                                       <th><td>
                                         <form class="" action="<?php echo base_url() ?>index.php/homeRegisseurControlleur/ajout_debut" method="post">
                                           <input type="hidden" name="txt_hidden" value="<?php echo $carte->id_carte; ?>">
                                           <input type="hidden" name="txt_hidden1" value="<?php echo $carte->ID_CLIENT2; ?>">
                                           <input type="hidden" name="txt_hidden2" value="<?php echo $carte->ID_PANNEAU; ?>">
                                           <input type="hidden" name="txt_hidden3" value="<?php echo $carte->ID_REGISSEUR; ?>">
                                           <input class="datepicker" data-date-format="yyyy/mm/dd" id="debut" name="debut" placeholder="Debut de Reservation" required></td>
                                           <td><input class="datepicker" data-date-format="yyyy/mm/dd" id="fin" name="fin" placeholder="Fin de Reservation" required></td>
                                           <td><input value="Enregistrer" type="submit"></td>
                                         </form>
                                       </th>
                                     <?php }else { ?>
                                       <th>Debut Contrat : <?php echo $carte->debut;?>
                                       <th>Fin Contrat : <?php echo $carte->fin;?></th>
                                       <?php
                                       $date1  = $carte->debut;
                                       $date2 = $carte->fin;
                                        ...
                                        $date = date('d-m-Y ');
                                        $date = strtotime($date);
                                        $nbJoursTimestamp = $date2 - $date;
                                        //$nbJours = $nbJoursTimestamp/86400; // 86 400 = 60*60*24
                                        $nbJours = $nbJoursTimestamp/86400;
                                        ?>
                                       <th>Compteur : <?php echo $nbJours; ?> Jours</th>
             ...
             <?php
               ...
               <div class="form-group">
                 <p><center>Aucun Panneau Reserver</center></p>
               </div>
             <?php } ?>
