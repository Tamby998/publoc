      ...
      <div id="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="col-md-12">
                        <h1>Service Prestataires</h1>
                        		<!-- MODAL ADD -->
                            <form action="<?php echo base_url() ?>index.php/homeAdminControlleur/prestataire_service" method="post">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="mydata">
                        ...
                        <tbody>
                          ...
                          ?>
                          <td><?php echo $service->id_prestataire; ?></td>
                          <td><?php echo $service->service; ?></td>
                          <td><a href="<?php echo base_url() ?>index.php/HomeAdminControlleur/edit_service/<?php echo $service->id_prestataire; ?>" class="btn btn-success">Modifier</a>
                          <td><a href="<?php echo base_url() ?>index.php/homeAdminControlleur/delete_service/<?php echo $service->id_prestataire; ?>" class="btn btn-primary">supprimer</a>
