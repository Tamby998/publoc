...
padding-top: 1.4rem;
    ...
    <header id="header" class="sticky top-0 flex shadow-lg py-2 bg-white" style="z-index:1000;">
         ...
         <div class="row">
             <?php foreach ($favoris AS $info) {?>
               <?php
               $status = $info->status;
               $status_panneau = $info->STATUS;
                 if ($status == 1) { ?>
                       ...
                       <div class="row text-center">
                           ...
                           <div class="col-lg-8">
                               <table class="table">
                                   ...
                                   <tr>
                                   <th>        <a class="btn btn-info" href="<?php echo base_url() ?>index.php/homeClientControlleur/ajout/<?php echo $info->ID_PANNEAU; ?>">Reserver</a></th>
                                   <td><a href="<?php echo base_url() ?>index.php/homeClientControlleur/delete_favoris/<?php echo $info->id_favoris; ?>" class="btn btn-info">Supprimer</a></td>
                                   <td><a href="<?php echo base_url() ?>index.php/homeClientControlleur/plusdetails/<?php echo $info->ID_PANNEAU; ?>" class="btn btn-info">Plus de details</a></td>
                                  </tr>
                                   </tbody>
                                </table>
                           </div>
