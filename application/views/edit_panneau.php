...
<li class="parent">
    ...
    <main class="content" role="content">
      ...
      <!-- MultiStep Form -->
      <form id="regForm" action="<?php echo base_url() ?>index.php/RegisseurControlleur/update" method="post">
        <!-- One "tab" for each step in the form: -->
        <div class="tab">
          <h1>Etape 1 : Concernant l’emplacement </h1>
          <div class="form-gp">
            <input type="hidden" name="txt_hidden" id="<?php echo $panneau->ID_PANNEAU; ?>" value="<?php echo $panneau->ID_PANNEAU; ?>">
          ...
          <p><input type="text" id="REFERENCE" name="REFERENCE" max="20" min="1" value="<?php echo $panneau->REFERENCE; ?>" placeholder="Référence de l’Emplacement ..." required /></p><br>
          <p>Longueur:</p>
        ...
        <div class="tab">
          ...
          <div class="form-gp">
            ...
            <select id="PERIODE" name="PERIODE" required>
              <option id="<?php echo $panneau->PERIODE; ?>" value="<?php echo $panneau->PERIODE; ?>"><?php echo $panneau->PERIODE; ?></option>
              <option id="Mensuelle (Par mois)" value="Mensuelle (Par mois)">Mensuelle (par mois)</option>
              <option id="Trimestrielle (Tous les 3 mois)" value="Trimestrielle (Tous les 3 mois)">Trimestrielle (tous les 3 mois)</option>
              <option id="Semestrielle (Tous les 6 mois)" value="Semestrielle (Tous les 6 mois)">Semestrielle (tous les 6 mois)</option>
              <option id="" value="Annuel (Tous les ans)">Annuel (Tous les ans)</option>
            </select>
          </div><br>
          <div class="form-gp">
            <label id="fav-label">
