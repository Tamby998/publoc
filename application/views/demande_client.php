    ...
    <header id="header" class="sticky top-0 flex shadow-lg py-2 bg-white" style="z-index:1000;">
       ...
       <main class="flexbox-col">
         ...
         <div class="form-wrapper">
           <form id="form" method="post" name="emailform" action="<?php echo base_url() ?>index.php/homeClientControlleur/insert">
             <input type="hidden" name="txt_hidden" value="ID_DEMANDE">
             <h3 class="form-title">Faire une Demande au Regisseur</h3>
             <div class="form-input-max">
               <p class="form-text">A la recherche de : :</p>
               <div class="form-input-wrapper flexbox-left">
                 <i class="uil uil-at"></i>
                 <select class="form-input" name="TYPE" id='TYPE' required >
                   <option disabled="" selected="" value="">Veiller selectionner votre type</option>
                   <option id="Panneaux" value="Panneaux">Panneaux</option>
                   <option id="Mur Facade" value="Mur Facade">Mur Facade</option>
                   <option id="Digitals" value="Digitals">Digitals</option>
                   <option id="Vehicule Taxi-Ville" value="Vehicule Taxi-Ville">Vehicule Taxi-Ville</option>
                   <option id="Vehicule Bus" value="Vehicule Bus">Vehicule Bus</option>
                   <option id="Vehicule Entreprise" value="Vehicule Entreprise">Vehicule Entreprise</option>
                   <option id="Vehicule Tuc tuc" value="Vehicule Tuc tuc">Vehicule Tuc tuc</option>
                   <option id="Mangasine Journal" value="Mangasine Journal">Mangasine Journal</option>
                   <option id="Mangasine Revus" value="Mangasine Revus">Mangasine Revus</option>
                 </select>
              </div>
             </div>
             <div class="form-input-grid">
               ...
               <div>
               <p class="form-text">Dimension recherché :</p>
               <div class="form-input-wrapper flexbox-left">
                 <i class="uil uil-asterisk"></i>
                 <input class="form-input" id="dimension" name="dimension" type="text" placeholder="Dimension ..." aria-label="" required>
               </div>
             </div>
               <div>
               <p class="form-text">Nombre au total :</p>
               <div class="form-input-wrapper flexbox-left">
                 <i class="uil uil-asterisk"></i>
                 <input class="form-input" id="nombre" name="nombre" type="number" max="200" min="1" placeholder="Nombre au total ..." aria-label="" required>
               </div>
             </div>
               <div>
               <p class="form-text">Emplacement du lieu : :</p>
               <div class="form-input-wrapper flexbox-left">
                 <i class="uil uil-asterisk"></i>
                 <input class="form-input" id="lieu1" name="lieu1" type="text" placeholder="Emplacement du lieu ..." aria-label="" required>
               </div>
             </div>
               <div>
               <p class="form-text">Nombre au total :</p>
               <div class="form-input-wrapper flexbox-left">
                 <i class="uil uil-asterisk"></i>
                 <input class="form-input" id="nombre_1" name="nombre_1" type="number" max="200" min="1" placeholder="Nombre au total ..." aria-label="" required>
               </div>
             </div>
               <div>
               <p class="form-text">Emplacement du lieu 1: :</p>
               <div class="form-input-wrapper flexbox-left">
                 <i class="uil uil-asterisk"></i>
                 <input class="form-input" id="lieu2" name="lieu2" type="text" placeholder="Emplacement du lieu ..." aria-label="" >
               </div>
             </div>
               <div>
               <p class="form-text">Nombre au total 1:</p>
               <div class="form-input-wrapper flexbox-left">
                 <i class="uil uil-asterisk"></i>
                 <input class="form-input" id="nombre_2" name="nombre_2" type="number" max="200" min="1" placeholder="Nombre au total ..." aria-label="">
               </div>
             </div>
               <div>
           ...
           <div class="form-input-max">
             <p class="form-text">Type de Commande :</p>
             <div class="form-input-wrapper flexbox-left">
               <i class="uil uil-at"></i>
               <select name="SERVICE" id='SERVICE' class="form-input" required >
                 <option disabled="" selected="" value="">Veiller selectionner votre services</option>
                 <option id="Location de l'emplacement" value="Location de l'emplacement">Location de l'emplacement</option>
                 <option id="Location et Conception" value="Location et Conception">Location et Conception</option>
                 <option id="Location, Conception et Pose" value="Location, Conception et Pose">Location, Conception et Pose</option>
               </select>
            </div>
           </div>
           <div class="form-input-max">
             <p class="form-text">Type Compte :</p>
             <div class="form-input-wrapper flexbox-left">
               <i class="uil uil-at"></i>
               <select name="TYPE_COMPTE" id='TYPE_COMPTE' class="form-input" required >
                 <option id="Location de l'emplacement" value="<?php echo $_SESSION['TYPE_COMPTE']; ?>"><?php echo $_SESSION['TYPE_COMPTE']; ?></option>
               </select>
            </div>
           </div>
           <div class="form-input-max">
             <p class="form-text">Votre ID :</p>
             <div class="form-input-wrapper flexbox-left">
               <i class="uil uil-at"></i>
               <select name="ID_CLIENT2" id='ID_CLIENT2' class="form-input" required >
                 <option id="<?php echo $_SESSION['ID_CLIENT2']; ?>" value="<?php echo $_SESSION['ID_CLIENT2']; ?>"><?php echo $_SESSION['ID_CLIENT2']; ?></option>
               </select>
            </div>
           </div>
           </div>
