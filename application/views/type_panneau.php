            ...
            <div class="row">
                <div class="col-12">
                    <div class="col-md-12">
                        <h1>Type Panneau</h1>
                        		<!-- MODAL ADD -->
                            <form action="<?php echo base_url() ?>index.php/homeAdminControlleur/save_type" method="post">
                                  <div class="modal-body">
                                                <div class="form-group row">
                                                    <label class="col-md-2 col-form-label">Type</label>
                                                    <div class="col-md-10">
                                                      <input type="text" name="type" id="type" class="form-control" placeholder="Titre..." required>
                                                    </div>
                                                </div>
                                              <!--  <div class="form-group row">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="mydata">
                        ...
                        <tbody>
                          ...
                          <td><a href="<?php echo base_url() ?>index.php/HomeAdminControlleur/edit/<?php echo $type->id; ?>" class="btn btn-success">Modifier</a>
                          <td><a href="<?php echo base_url() ?>index.php/homeAdminControlleur/delete/<?php echo $type->id; ?>" class="btn btn-primary">supprimer</a>
