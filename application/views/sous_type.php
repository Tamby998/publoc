            ...
            <div class="row">
                <div class="col-12">
                    <div class="col-md-12">
                        <h1>Sous Type</h1>
                        		<!-- MODAL ADD -->
                            <form action="<?php echo base_url() ?>index.php/homeAdminControlleur/save_sous" method="post">
                                    ...
                                    <div class="form-group row">
                                      <select class="form-control" name="id_type" id="id_type" required>
                                        ...
                                        <?php } ?>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-2 col-form-label">Sous-type</label>
                                                    <div class="col-md-10">
                                                      <input type="text" name="sous" id="sous" class="form-control" placeholder="Sous Type ..." required>
                                                    </div>
                                                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="mydata">
                        ...
                        <tbody>
                          <?php if((sizeof($souss))>0){
                          foreach($souss as $type){
                          ?>
                          <td><?php echo $type->id; ?></td>
                          <td><?php echo $type->sous; ?></td>
                          <td><?php echo $type->id_type; ?></td>
                          <td><a href="<?php echo base_url() ?>index.php/HomeAdminControlleur/edit_sous/<?php echo $type->id; ?>" class="btn btn-success">Modifier</a>
                          <td><a href="<?php echo base_url() ?>index.php/homeAdminControlleur/delete_sous/<?php echo $type->id; ?>" class="btn btn-primary">supprimer</a>
