...
<!-- Page Heading -->
<div class="sucess">
    <h1> <center>Bienvenue <?php echo $_SESSION['username']; ?>!</center></h1>
    <p><center>C'est votre tableau de bord.</center></p>
</div>
<center><a href="<?php echo base_url() ?>index.php/homeAdminControlleur/type_panneau" class="btn btn-primary">Type Panneau</a> || <a href="<?php echo base_url() ?>index.php/homeAdminControlleur/sous_type" class="btn btn-primary">Sous-type</a> || <a href="<?php echo base_url() ?>index.php/homeAdminControlleur/ville" class="btn btn-primary">Ville</a> || <a href="<?php echo base_url() ?>index.php/homeAdminControlleur/quartier" class="btn btn-primary">Quartier</a>|| <a href="<?php echo base_url() ?>index.php/homeAdminControlleur/service" class="btn btn-primary">Service Prestataire</a><br></center>
    ...
    <div class="card border-left-primary shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Nombre Admin</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800">
             <h4>Total Admin: <?php echo $this->db->count_all('admin'); ?></h4>
  ...
  <div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-success shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Nombre Clients</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $this->db->count_all('client'); ?></div>
          </div>
          <div class="col-auto">
  ...
  <div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-info shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Nombre des Prestataires</div>
            <div class="row no-gutters align-items-center">
              <div class="col-auto">
                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $this->db->count_all('prestataire'); ?></div>
              </div>
              <div class="col">
  ...
  <div class="col-xl-3 col-md-6 mb-4">
    <div class="card border-left-warning shadow h-100 py-2">
      <div class="card-body">
        <div class="row no-gutters align-items-center">
          <div class="col mr-2">
            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Nombre Regisseurs</div>
            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $this->db->count_all('regisseur'); ?></div>
          </div>
          <div class="col-auto">
