...
<!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row">
      			<div class="col-lg-12">
      				<h1 class="page-header">Panneau <span class=" glyphicon glyphicon-list-alt"></span></h1>
      			</div>
      		</div><!--/.row-->
      		...
      		<div class="row">
      			<div class="col-lg-12">
      				<div class="panel panel-primary">
      					<div class="panel-heading">Listes des pannneaux</div>
                  ...
                  <div class="table-responsive">
                              ...
                              <tr class="winner__table">
                                ...
                                <th><i class="fa fa-tasks" aria-hidden="true"></i> Ville</th>
                                <th><i class="fa fa-map-marker" aria-hidden="true"></i> Adresse</th>
                                <th><i class="fa fa-bookmark" aria-hidden="true"></i> Status</th>
                                <th><i class="fa fa-bookmark" aria-hidden="true"></i> Panneau</th>
                                <th><i class="fa fa-bookmark" aria-hidden="true"></i> Gerer par</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr class="winner__table">
      										  </thead>
                            <?php if((sizeof($panneaus))>0){
                            foreach($panneaus as $panneau){
                            ?>
      										  <tbody>
                              ...
                              <td>
                                <?php
                                  ...
                                  if ($status == 1) { ?>
                                    <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/update_status_panneau?$ID_PANNEAU=<?php echo $panneau->ID_PANNEAU; ?>&$status=<?php echo $panneau->STATUS; ?>" type="button" class="btn btn-success" name="button">Active</a>
                               <?php
                             }else { ?>
                               <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/update_status_panneau?$ID_PANNEAU=<?php echo $panneau->ID_PANNEAU; ?>&$status=<?php echo $panneau->STATUS; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                               <?php
                             }
                                 ?>
                              </td>
                              <td>
                                <?php
                                  $status = $panneau->verifier;
                                  if ($status == 1) { ?>
                                    <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/update_verifier_panneau?$ID_PANNEAU=<?php echo $panneau->ID_PANNEAU; ?>&$status=<?php echo $panneau->verifier; ?>" type="button" class="btn btn-success" name="button">Verifier</a>
                               <?php
                             }else { ?>
                               <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/update_verifier_panneau?$ID_PANNEAU=<?php echo $panneau->ID_PANNEAU; ?>&$status=<?php echo $panneau->verifier; ?>" type="button" class="btn btn-primary" name="button">Non Verifier</a>
                               <?php
                             }
                                 ?>
                              </td>
                              <td>
                                ...
                                if ($gerer == 0 ) { ?>
                                  <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/update_gerer?$ID_PANNEAU=<?php echo $panneau->ID_PANNEAU; ?>&$gerer=<?php echo $panneau->gerer; ?>" type="button" class="btn btn-success" name="button">Proprietaire</a>
                                <?php }else{ ?>
                                  <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/update_gerer?$ID_PANNEAU=<?php echo $panneau->ID_PANNEAU; ?>&$gerer=<?php echo $panneau->gerer; ?>" type="button" class="btn btn-primary" name="button">Wellcomm</a>
                                <?php } ?>
                              </td>
      										  </tbody>
                            <?php
                          ...
                          <td>Aucun Emplacement recuperer</td>
                          <td>Aucun Emplacement recuperer</td>
                          <td>Aucun Emplacement recuperer</td>
                          <td>Aucun Emplacement recuperer</td>
                          <td>Aucun Emplacement recuperer</td>
