...
<html lang="en">
   ...
   <body>
      ...
      <div class="container mt-5">
        <form action="<?php echo site_url('prestataireControlleur/save_real')?>" method="post" enctype="multipart/form-data">
          <div class="form-row">
            <input type="hidden" name="txt_hidden" value="<?php echo $_SESSION['ID_PRESTATAIRE']; ?>">
            <input type="hidden" name="id_realisation">
            <div class="form-group col-md-6">
              <label for="telefon">Photo de Realisation</label>
              <input type="file" id="nom_image" name="nom_image" class="form-control-file" required>
            </div><br>
          <div class="form-group">
            <label for="telefon">Description</label>
            <textarea class="form-control" id="description" name="description" placeholder="Description ...." rows="5"></textarea>
          </div>



          <center><button type="submit" class="btn btn-primary" name="fg-gonder">Enrengistrer</button></center>
        </div>
        </form>
      </div><br>
  ...
  <table class="table table-striped  table-hover " id="myTable">
    ...
    <thead>
                                   ...
                                   <tbody>
                                     <?php if((sizeof($realisation))>0){
                                     foreach($realisation as $info){
                                     ?>
                                      <tr>

                                          <td><?php echo $info->description; ?></td>
                                          <td>
                                          <a href="#"><img src="<?php echo base_url() ?>upload/<?php echo $info->nom_image; ?>" style="width:100px;" /></a>
                                          </td>
                                          <td><a href="<?php echo base_url() ?>index.php/homePrestataireControlleur/delete_real/<?php echo $info->id_realisation; ?>" class="btn btn-primary">supprimer</a>
