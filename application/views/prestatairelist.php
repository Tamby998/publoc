...
<!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="row">
      			<div class="col-lg-12">
      				<h1 class="page-header">Prestataires <span class=" glyphicon glyphicon-list-alt"></span></h1>
      			</div>
      		</div><!--/.row-->
      		...
      		<div class="row">
      			<div class="col-lg-12">
      				<div class="panel panel-primary">
      					<div class="panel-heading">Listes des prestataires</div>
      					<div class="panel-body">
                                  ...
                                  <div class="table-responsive">
      								<table class="table table-striped table-bordered table-hover" id="mydata">
      										  ...
      										  <tr>
      										      ...
      										      <th style="color: #333536;"><span class="glyphicon glyphicon-map-marker"></span> Email</th>
      										      <th style="color: #333536;"><span class="glyphicon glyphicon-map-marker"></span> Status</th>
      										      <th style="color: #333536;"><span class="glyphicon glyphicon-map-marker"></span> Imprimerie</th>
      										      <th style="color: #333536;"><span class="glyphicon glyphicon-map-marker"></span> Conseil</th>
      										      <th style="color: #333536;"><span class="glyphicon glyphicon-map-marker"></span> Concepteur</th>
      										      <th style="color: #333536;"><span class="glyphicon glyphicon-map-marker"></span> Action</th>
      										  </tr>
      										  </thead>
                            <?php if((sizeof($prestataires))>0){
                              ...
                              <td><?php echo $prestataire->NOM_PRESTATAIRE; ?></td>
                              <td><?php echo $prestataire->CONTACT_PRESTATAIRE; ?></td>
                              <td><?php echo $prestataire->EMAIL_PRESTATAIRE; ?></td>
                              <td>
                                <?php
                                  $status = $prestataire->status;
                                  if ($status == 1) { ?>
                                    <a href="update_status?$ID_PRESTATAIRE=<?php echo $prestataire->ID_PRESTATAIRE; ?>&$status=<?php echo $prestataire->status; ?>" type="button" class="btn btn-success" name="button">Active</a>
                               <?php
                             }else { ?>
                               <a href="update_status?$ID_PRESTATAIRE=<?php echo $prestataire->ID_PRESTATAIRE; ?>&$status=<?php echo $prestataire->status; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                               <?php
                             }
                                 ?>
                              </td>
                              <td>
                                <?php
                                  $imprimerie = $prestataire->imprimerie;
                                  if ($imprimerie == 1) { ?>
                                    <a href="update_status_imprimerie?$ID_PRESTATAIRE=<?php echo $prestataire->ID_PRESTATAIRE; ?>&$status=<?php echo $prestataire->imprimerie; ?>" type="button" class="btn btn-success" name="button">Active</a>
                               <?php
                             }else { ?>
                               <a href="update_status_imprimerie?$ID_PRESTATAIRE=<?php echo $prestataire->ID_PRESTATAIRE; ?>&$status=<?php echo $prestataire->imprimerie; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                               <?php
                             }
                                 ?>
                              </td>
                              <td>
                                <?php
                                  $conseil = $prestataire->conseil;
                                  if ($conseil == 1) { ?>
                                    <a href="update_status_conseil?$ID_PRESTATAIRE=<?php echo $prestataire->ID_PRESTATAIRE; ?>&$status=<?php echo $prestataire->conseil; ?>" type="button" class="btn btn-success" name="button">Active</a>
                               <?php
                             }else { ?>
                               <a href="update_status_conseil?$ID_PRESTATAIRE=<?php echo $prestataire->ID_PRESTATAIRE; ?>&$status=<?php echo $prestataire->conseil; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                               <?php
                             }
                                 ?>
                              </td>
                              <td>
                                <?php
                                  $concepteur = $prestataire->concepteur;
                                  if ($concepteur == 1) { ?>
                                    <a href="update_status_concepteur?$ID_PRESTATAIRE=<?php echo $prestataire->ID_PRESTATAIRE; ?>&$status=<?php echo $prestataire->concepteur; ?>" type="button" class="btn btn-success" name="button">Active</a>
                               <?php
                             }else { ?>
                               <a href="update_status_concepteur?$ID_PRESTATAIRE=<?php echo $prestataire->ID_PRESTATAIRE; ?>&$status=<?php echo $prestataire->concepteur; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                               <?php
                             }
                                 ?>
                              </td>
                              <td><a href="<?php echo base_url() ?>index.php/PrestataireControlleur/delete/<?php echo $prestataire->ID_PRESTATAIRE; ?>" class="btn btn-danger">supprimer</a>
