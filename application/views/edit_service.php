                ...
                <div class="col-12">
                    <div class="col-md-12">
                        <h1>Modifier Service</h1>
                        		<!-- MODAL ADD -->
                            <form action="<?php echo base_url() ?>index.php/homeAdminControlleur/update_service" method="post">
                                  <div class="modal-body">
                                    <input type="hidden" name="txt_hidden" value="<?php echo $type->id_prestataire; ?>">
                                                <div class="form-group row">
                                                    <label class="col-md-2 col-form-label">Service</label>
                                                    <div class="col-md-10">
                                                      <input type="text" name="service" id="service" value="<?php echo $type->service; ?>" class="form-control" placeholder="Quartier..." required>
                                                    </div>
                                                </div>
                                                      <!--  <div class="form-group row">
