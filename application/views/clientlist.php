                ...
                <div class="table-responsive">
      								<table class="table table-striped table-bordered table-hover" id="mydata">
      										  ...
      										  <tr>
      										      ...
      										      <th style="color: #333536;"><span class="glyphicon glyphicon-plus"></span> Prénoms</th>
                            ...
                            <?php if((sizeof($clients))>0){
                              foreach($clients as $client){
                                ?>
      										  <tbody>
                              <td><?php echo $client->ID_CLIENT2; ?></td>
                              <td><?php echo $client->NOM_CLIENT; ?></td>
                              <td><?php echo $client->PRENOM_CLIENT; ?></td>
                              <td><?php echo $client->NUM_CLIENT; ?></td>
                              <td><?php echo $client->EMAIL_CLIENT; ?></td>
                              <td><?php echo $client->TYPE_COMPTE; ?></td>
                              <td>
                                <?php
                                  $status = $client->status;
                                  if ($status == 1) { ?>
                                    <a href="update_status?$ID_CLIENT2=<?php echo $client->ID_CLIENT2; ?>&$status=<?php echo $client->status; ?>" type="button" class="btn btn-success" name="button">Active</a>
                               <?php
                             }else { ?>
                               <a href="update_status?$ID_CLIENT2=<?php echo $client->ID_CLIENT2; ?>&$status=<?php echo $client->status; ?>" type="button" class="btn btn-primary" name="button">Desactive</a>
                               <?php
                             }
                                 ?>
                              </td>
                              <td><a href="<?php echo base_url() ?>index.php/ClientControlleur/delete/<?php echo $client->ID_CLIENT2; ?>" class="btn btn-danger">supprimer</a>
