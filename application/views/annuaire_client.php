   ...
   <head>
    ...
    <header id="header" class="text-gray-800 sticky top-0 flex shadow-lg py-2 bg-white" style="z-index:1000;">
       ...
       <section id="services" class="services section-bg my-5">
         <center><a href="<?php echo base_url() ?>index.php/homeClientControlleur/concepteur" class="rounded bg-green-600 p-2 text-white hover:bg-green-700">Concepteur</a>      ||    <a href="<?php echo base_url() ?>index.php/homeClientControlleur/imprimerie"class="rounded bg-blue-600 p-2 text-white hover:bg-blue-700">Imprimerie</a>     ||     <a href="<?php echo base_url() ?>index.php/homeClientControlleur/conseil"class="rounded bg-blue-600 p-2 text-white hover:bg-blue-700">Conseil</a></center>
       ...
       <div class="container" data-aos="fade-up">
         <div class="flex justify-center items-center">
           <span class="text-4xl text-gray-500">Concepteur</span>
         </div>
