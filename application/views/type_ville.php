      ...
      <div id="content">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="col-md-12">
                        <h1>Ville et Region</h1>
                        		<!-- MODAL ADD -->
                            <form action="<?php echo base_url() ?>index.php/homeAdminControlleur/save_ville" method="post">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="mydata">
                        ...
                        <tbody>
                          ...
                          <td><?php echo $type->ville; ?></td>
                          <td><a href="<?php echo base_url() ?>index.php/HomeAdminControlleur/edit_ville/<?php echo $type->id; ?>" class="btn btn-success">Modifier</a>
                          <td><a href="<?php echo base_url() ?>index.php/homeAdminControlleur/delete_ville/<?php echo $type->id; ?>" class="btn btn-primary">supprimer</a>
