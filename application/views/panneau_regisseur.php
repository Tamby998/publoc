	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
      ...
      <div class="container">
          <div class="table-responsive">
            <br><center>
              <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/list/<?php echo $_SESSION['ID_REGISSEUR']; ?>" class="btn btn-danger">Tous les Emplacements</a> || <a href="<?php echo base_url() ?>index.php/RegisseurControlleur/disponible/<?php echo $_SESSION['ID_REGISSEUR']; ?>" class="btn btn-info">Emplacements Disponibles</a>
              ||<a class="btn btn-info" href="<?php echo base_url() ?>index.php/homeRegisseurControlleur/historique/<?php echo $_SESSION['ID_REGISSEUR'];?>" class="btn btn-info">Emplacement Assigner</a></center><br>
            <center><form class="" action="<?php echo site_url('homeRegisseurControlleur/recherche'); ?>" method="post">
            <input type="text"  name="MOT_CLES" placeholder="Par Mot-cles ..." required> <input type="submit" value="Recherche">
          </form></center>
          <table class="table table-bordered   table-striped" style="margin-top:100px">
            <thead class="table__head">
              <tr class="winner__table">
                <th>Ref</th>
                <th><i class="fa fa-user" aria-hidden="true"></i> Type</th>
                <th><i class="fa fa-flag-o" aria-hidden="true"></i> Service</th>
                <th><i class="fa fa-window-close-o" aria-hidden="true"></i> Description</th>
                <th><i class="fa fa-map-marker" aria-hidden="true"></i> Ville</th>
                <th><i class="fa fa-map-marker" aria-hidden="true"></i> Adresse</th>
                <th><i class="fa fa-key" aria-hidden="true"></i> Mot-Cles</th>
                <th><i class="fa fa-bookmark" aria-hidden="true"></i> Status</th>
                <th><i class="fa fa-caret-square-o-right" aria-hidden="true"></i> Actions</th>
                <th><i class="fa fa-caret-square-o-right" aria-hidden="true"></i> Actions</th>
                <th><i class="fa fa-caret-square-o-right" aria-hidden="true"></i> Voir</th>
                <th><i class="fa fa-caret-square-o-right" aria-hidden="true"></i> Assigner</th>
              </tr>
            </thead>
            <tbody>
              <tr class="winner__table">
                <?php if((sizeof($cartes))>0){
                  foreach($cartes as $panneau){
                    ?>
                <td><?php echo $panneau->REFERENCE; ?></td>
                <td><?php echo $panneau->TYPE; ?></td>
                <td><?php echo $panneau->SERVICE; ?></td>
                <td><?php echo $panneau->DESCRIPTION; ?></td>
                <td><?php echo $panneau->VILLE; ?></td>
                <td><?php echo $panneau->ADRESSE; ?></td>
                <td><?php echo $panneau->MOT_CLES; ?></td>
                <?php
                  $status = $panneau->status_carte;
                  if ($status == 1) { ?>
                  <td><button type="button" class="btn btn-danger" name="button" disabled>En Location</button></td>
               <?php
             }else { ?>
                 <td><button type="button" class="btn btn-info" name="button" disabled>En Attente</button></td>
               <?php
             }
                 ?>
                 <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/edit/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-success">Modifier</a>
                 <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/delete_panneau/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-primary">supprimer</a>
                <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/panneau/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-info">Emplacement</a></a>
                <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/panneau/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-info" disabled>Client</a></a>
              </tr>
              <?php
            }?>
            <?php
          ...
          <?php } ?>
              <tr class="winner__table">
                <?php if((sizeof($disponibles))>0){
                  foreach($disponibles as $panneau){
                    ?>
                <td><?php echo $panneau->REFERENCE; ?></td>
                <td><?php echo $panneau->TYPE; ?></td>
                <td><?php echo $panneau->SERVICE; ?></td>
                ...
                <td><?php echo $panneau->MOT_CLES; ?></td>
                <?php
                  $status = $panneau->STATUS;
                  if ($status == 1) { ?>
                  <td><button type="button" class="btn btn-danger" name="button" disabled>Disponible</button></td>
               <?php
             }else { ?>
                 <td><button type="button" class="btn btn-info" name="button" disabled>Desactiver</button></td>
               <?php
             }
                 ?>
                 <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/edit/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-success">Modifier</a>
                 <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/delete_panneau/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-primary">supprimer</a>
                <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/panneau/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-info">Emplacement</a></a>
                <td><a href="<?php echo base_url() ?>index.php/RegisseurControlleur/assigner/<?php echo $panneau->ID_PANNEAU; ?>" class="btn btn-danger">Client</a></a>
              </tr>
