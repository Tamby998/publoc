                 ...
                 <div class="jumbotron">
                     <div class="row text-center">
                         <div class="col-lg-4">
                             ...
                             <h2 class="name"><?php echo $client->NOM_CLIENT; ?>  <?php echo $client->PRENOM_CLIENT; ?></h2>
                             <h4 class="number">#<?php echo $client->ID_CLIENT2; ?></h4>
                         </div>
                         <div class="col-lg-8">
                             <table class="table">
                                 <tbody>
                                 <tr>
                                     <th><i class="fa fa-envelope-open-o" aria-hidden="true"> Adresse :</i></th>
                                     <td><?php echo $client->ADRESSE_CLIENT; ?></td>
                                 </tr>
                                 <tr>
                                     <th><i class="fa fa-volume-control-phone" aria-hidden="true">  Numero Client:</i></th>
                                     <td><?php echo $client->NUM_CLIENT; ?></td>
                                 </tr>
                                 <tr>
                                     <th><i class="fa fa-volume-control-phone" aria-hidden="true">  Email Client:</i></th>
                                     <td><?php echo $client->EMAIL_CLIENT; ?></td>
                                 </tr>
                                 <tr>
                                   <th><i class="fa fa-map-marker" aria-hidden="true"> Type Compte :</i></th>
                                   <td><?php echo $client->TYPE_COMPTE; ?></td>
                                 </tr>
                                 <tr>
                                   <th><a href="<?php echo base_url() ?>index.php/homeRegisseurControlleur/list_panneau_reserver/<?php echo $_SESSION['ID_REGISSEUR']; ?>" class="btn btn-info">Retour</a></th>
                                 </tr>
                                 </tbody>
                             </table>
                         </div>
