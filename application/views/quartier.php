            ...
            <div class="row">
                <div class="col-12">
                    <div class="col-md-12">
                        <h1>Quartier</h1>
                        		<!-- MODAL ADD -->
                            <form action="<?php echo base_url() ?>index.php/homeAdminControlleur/save_quartier" method="post">
                                  <div class="modal-body">
                                    <div class="form-group row">
                                      <select class="form-control" name="id_ville" id="id_ville" required>
                                        <option value="">Selectionner le ville</option>
                                        <?php if((sizeof($villes))>0){
                                          foreach($villes as $type){
                                            ?>
                                            <option value="<?php echo $type->id;  ?>"><?php echo $type->ville;  ?></option>
                                            <?php
                                          }
                                        }else{ ?>
                                        ...
                                        <?php } ?>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-2 col-form-label">Quartier</label>
                                                    <div class="col-md-10">
                                                      <input type="text" name="quartier" id="quartier" class="form-control" placeholder="Quartier ..." required>
                                                    </div>
                                                </div>
                                              ...
                                              <!--  <div class="form-group row">
                                                  ...
                                                  <input type="file" name="image" id="image"  accept=".jpg,.jpeg,.gif,.png" required="required" />
                                                </div>
                                          </div>-->
                    ...
                    <table class="table table-striped table-bordered table-hover" id="mydata">
                        ...
                        <tbody>
                          <?php if((sizeof($quartier))>0){
                          foreach($quartier as $type){
                          ?>
                          <td><?php echo $type->id; ?></td>
                          <td><?php echo $type->quartier; ?></td>
                          <td><?php echo $type->id_ville; ?></td>
                          <td><a href="<?php echo base_url() ?>index.php/HomeAdminControlleur/edit_quartier/<?php echo $type->id; ?>" class="btn btn-success">Modifier</a>
                          <td><a href="<?php echo base_url() ?>index.php/homeAdminControlleur/delete_quartier/<?php echo $type->id; ?>" class="btn btn-primary">supprimer</a>
