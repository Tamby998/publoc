                          ...
                          <div class="modal-body">
                            <input type="hidden" name="txt_hidden" value="<?php echo $blog->id; ?>">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                              <input type="text" name="titre" id="titre" value="<?php echo $blog->titre; ?>" class="form-control" placeholder="Titre..." required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-2 col-form-label">Description</label>
                                            <div class="col-md-10">
                                              <textarea class="form-control" id="description" name="description"  rows="3" placeholder="Description ..." required><?php echo $blog->description; ?></textarea>
                                            </div>
                                        </div>
                                              <!--  <div class="form-group row">
