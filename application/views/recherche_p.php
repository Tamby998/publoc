    ...
    <ul class="nav menu">
      ...
      <li class="parent active">
        ...
        <ul class="children collapse" id="sub-item-2">
          ...
          <li>
            <a class="" href="<?php echo base_url() ?>index.php/homeRegisseurControlleur/historique/<?php echo $_SESSION['ID_REGISSEUR'];?>">
              <svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg> Emplacement Assigner
            </a>
          </li>
        </ul>
      </li>
      ...
      <div class="container">
          ...
          <table class="table table-bordered   table-striped" style="margin-top:100px">
            ...
            <tbody>
              ...
              foreach($results as $panneau){
              ?>
              <tr class="winner__table">
                <td><?php echo $panneau->ID_PANNEAU; ?></td>
            ...
            <br><tr>Aucun panneau trouver!</tr>
            <?php } ?>
            </table>
