...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Aucune données disponible dans la base" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default Aucune donnees disponible dans la base
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "Aucune donnees disponible dans la base"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "Aucune données disponible dans la base",
			 ...
			 *    } );
			 */
			"sInfo": "De _START_ à _END_ sur _TOTAL_ éxistants",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "De 0 à 0 sur 0 éxistants",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(filtrer dans _MAX_ aux totale)",
			 ...
			 *    } );
			 */
			"sLengthMenu": "voir _MENU_ entrer",
			 ...
			 *    } );
			 */
			"sZeroRecords": "La recherche ne correspond pas aux données éxistants"
		},
